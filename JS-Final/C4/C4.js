while (!player1){
    var player1 = ('Red (Player 1)');
};
var player1Color = 'red';

while (!player2){
    var player2 = ('Yellow (Player 2)');
};
        ...
        if (tableRow[i].children[column].style.backgroundColor == 'white'){
            ...
            if (currentPlayer === 1){
                ...
                if (horizontalCheck() || verticalCheck() || diagonalCheck() || diagonalCheck2()){
                    ...
                    return alert(`${player1} WINS!! Please Click Reset Button`);
                }else if (drawCheck()){
                    playerTurn.textContent = 'DRAW! Please Click Reset Button';
                    return alert('DRAW!');
                }else{
                ...
                if (horizontalCheck() || verticalCheck() || diagonalCheck() || diagonalCheck2()){
                    playerTurn.textContent = `${player2} WINS!! Please Click Reset Button`;
                    playerTurn.style.color = player2Color;
                    return alert(`${player2} WINS!! Please Click Reset Button`);
                }else if (drawCheck()){
                    playerTurn.textContent = 'DRAW! Please Click Reset Button';
                    return alert('DRAW! Please Click Reset Button');
                }else{
                    playerTurn.textContent = `${player1}'s turn`;
